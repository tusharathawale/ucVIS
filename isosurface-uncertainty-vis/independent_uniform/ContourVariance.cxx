...
struct ComputeEdgeVarianceWorklet : viskores::worklet::WorkletMapField
{
                         ...
                         const PortalType& inputVariance) const
  {
    ...
    double expected_uniform = u.kde_z_pdf_expected(&tempMean0, variance0, &tempMean1, variance1, interpMean);
    var = u.kde_z_pdf_variance(&tempMean0, variance0, &tempMean1, variance1, interpMean, expected_uniform);
    //u.kde_z_pdf_variance(&mean0, variance0, &mean1, variance1, interpMean, &expt, &cross_prob, &var);
